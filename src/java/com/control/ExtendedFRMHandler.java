...
public class ExtendedFRMHandler implements I_FRMType {
    ...
    public ExtendedFRMHandler() {
    }

    /** Creates new FRMHandler */
    public ExtendedFRMHandler(I_FRMInterface ifrm, HttpServletRequest request) {
...
//	        System.out.println("--st2 : "+st2);
    ...
    private void checkParamFormat(int idx) {
        ...
        switch (fieldTypes[idx] & FILTER_FORMAT){
            ...
            case FORMAT_EMAIL:
                if (!value.contains("@")) this.addError(idx, ExtendedFRMMessage.getErr(ExtendedFRMMessage.ERR_FORMAT));
                break;
    ...
    public String getParamValue(int idx) {
        if(idx >= paramValues.size()) return "";

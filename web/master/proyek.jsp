...
<script language="JavaScript">
                function cmdAdd(){
                    document.frmproyek.hidden_proyek_id.value="0";
                    document.frmproyek.command.value="<%=Command.ADD%>";
                    document.frmproyek.prev_command.value="<%=prevCommand%>";
                    document.frmproyek.action="index.jsp?page=master/proyek.jsp";
                    document.frmproyek.submit();
                }
                function cmdDelete(IDProyek){
                    document.frmproyek.hidden_proyek_id.value=IDProyek;
                    document.frmproyek.command.value="<%=Command.DELETE%>";
                    document.frmproyek.prev_command.value="<%=prevCommand%>";
                    document.frmproyek.action="index.jsp?page=master/proyek.jsp";
                    document.frmproyek.submit();
                }
                function cmdSave(){
                    document.frmproyek.command.value="<%=Command.SAVE%>";
                    document.frmproyek.prev_command.value="<%=prevCommand%>";
                    document.frmproyek.action="index.jsp?page=master/proyek.jsp";
                    document.frmproyek.submit();
                }                
                function cmdEdit(IDProyek){
                    document.frmproyek.hidden_proyek_id.value=IDProyek;
                    document.frmproyek.command.value="<%=Command.EDIT%>";
                    document.frmproyek.prev_command.value="<%=prevCommand%>";
                    document.frmproyek.action="index.jsp?page=master/proyek.jsp";
                    document.frmproyek.submit();
                }
      ...
      <table width="100%" border="0">
        <tr>
          <td><table width="100%" border="0">
            ...
            <tr>
              <td><%=i+start+1%></td>
              <td><a href="javascript:cmdEdit('<%=view.getOID()%>')"><%=view.getNamaProyek()%></a></td>
        ...
        <tr>
          <td>
              <%if((iCommand==Command.ADD)||(iCommand==Command.EDIT)||(frmProyek.errorSize()>0)){%>
              <table width="100%" border="0">
            <tr>
              <td colspan="2" bgcolor="#CCCCCC">Form Data Proyek</td>
            </tr>
            <tr>
              <td>Nama Proyek</td>
              <td><label>
                      <input name="<%=frmProyek.fieldNames[FrmProyek.FRM_NAMA_PROYEK]%>" type="text" id="textfield" value="<%=proyek.getNamaProyek()%>" size="40">
              </label></td>
            </tr>
            <tr>
              <td>Waktu Mulai</td>
              <td>
                  <label>
                      <%=ExtendedControlDate.drawDate(frmProyek.fieldNames[FrmProyek.FRM_TANGGAL_MULAI], proyek.getWaktuMulai())%>  
                      <%=ExtendedControlDate.drawTime(frmProyek.fieldNames[FrmProyek.FRM_WAKTU_MULAI], proyek.getWaktuMulai())%>                
                  </label>
              </td>
            </tr>
            <tr>
              ...
              <td>
                  <label>
                      <%=ExtendedControlDate.drawDate(frmProyek.fieldNames[FrmProyek.FRM_TANGGAL_SELESAI], proyek.getWaktuSelesai())%>   
                      <%=ExtendedControlDate.drawTime(frmProyek.fieldNames[FrmProyek.FRM_WAKTU_SELESAI], proyek.getWaktuSelesai())%>   
              </td>
            </tr>
            <tr>
              <td colspan="2"></td>
            ...
            <tr>
              <td colspan="2">
                ...
                <%if(IDProyek!=0){%>
                <input onclick="javascript:cmdDelete('<%=IDProyek%>')" type="submit" name="button3" id="button3" value="Delete">
              <%}%>
                  </td>
            </tr>
          </table>
